...
function main(options) {
    ...
    function start(app) {
        ...
        app.highlighter = s.highlighter = new highlighter.Highlighter(options.element);

        s.tempHighlighter = new highlighter.Highlighter(options.element, {
            highlightClass: 'annotator-hl-temporary'
        });
    ...
    return {
        ...
        beforeAnnotationCreated: function (annotation) {
            ...
            // done.
            s.tempHighlighter.draw(annotation);
            return new Promise((resolve, reject) => {
                s.editor.load(annotation, s.interactionPoint).then(() => {
                        s.tempHighlighter.undraw(annotation);
                        resolve()
                },
                    function () {
                        s.tempHighlighter.undraw(annotation);

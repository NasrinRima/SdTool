...
@section('body')
    ...
    <main class="content-wrap card">
        <div id="wiki_body_container" class="page-content clearfix" page-display="{{ $page->id }}">
...
@auth
@section('head')
    <link rel="stylesheet" href="{{ versioned_asset('dist/page-view.css') }}">
    <link rel="stylesheet" media="print" href="{{ versioned_asset('dist/highlighter.css') }}">

@endsection
@section('scripts')
    <script nonce="{{ $cspNonce }}" src="{{ asset('dist/page-view.js') }}"></script>
@endsection
@endauth

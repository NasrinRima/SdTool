...
use BookStack\Http\Controllers\AnnotatorController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::delete(
        '/books/{bookSlug}/page/{pageSlug}/revisions/{revId}/delete',
        [PageRevisionController::class, 'destroy']
    );
    ...
    Route::patch(
        '/settings/users/{id}/update-expansion-preference/{key}',
        [UserController::class, 'updateExpansionPreference']
    );
